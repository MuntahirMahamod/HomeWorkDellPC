...
public class HW_16_TestSeleniumMathod {
	WebDriver driver;
	
	@BeforeTest
	public void setUp(){ 
		System.setProperty("webdriver.chrome.driver","C:\\Users\\munta\\eclipse-workspace\\SeleniumMethods\\Driver\\chromedriver.exe");
...
//		boolean elementDisplayed = driver.findElement(By.xpath("//button[@id='cms-login-submit']")).isDisplayed();
//		System.out.println("Is the submit button test? Ans: " + elementDisplayed);
...
//	}
	...
	@Test (enabled = true, priority = 1)
		...
		boolean checkboxEnabled= driver.findElement(By.cssSelector("label.cms-label-tc.cms-checkbox-label")).isSelected();
		...
		//Q to Tofael Bro? I am using partial text instead of inner text. I got results and I fill more comfortable. Can I use its? is it correct way?
		WebElement testGetText= driver.findElement(By.xpath("//span[contains(text(), ' federal government website managed') ]"));
	...
	@Test (enabled = true, priority = 2)
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("//label[@class='cms-label-tc cms-checkbox-label' and @id='cms-label-tc']")).click();
		driver.findElement(By.id("cms-login-submit")).click();
		Thread.sleep(3000);
	}
